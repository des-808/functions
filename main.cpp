...
#include"func.h"
#include"func.cpp"	//Реализация шаблонной функции обязательно подключается на место вызова
#include"FillRand.h"
//#include"FillRand.cpp"	//Реализация НЕ шаблонной функции НИ В КОЕМ СЛУЧАЕ НЕ ПОДКЛЮЧАЕТСЯ НА МЕСТО ВЫЗОВА.
